  ...
  return (<>
    <Box
      ...
      sx={{
        ...
        transform: 'translateX(calc(100% * (var(--SideNavigation-mobileSlideIn, 0) - 1)))',
        position: 'fixed',
        top: 0,
        left: 0,
        width: '100vw',
        height: '100vh',
        opacity: 'var(--SideNavigation-mobileSlideIn, 0)',
    ...
    <Sheet
      sx={{
        ...
        transform: {
          xs: 'translateX(calc(100% * (var(--SideNavigation-mobileSlideIn, 0) - 1)))',
          md: 'unset'
        },
